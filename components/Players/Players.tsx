...
export const Players: React.FC<PlayersPropsI> = ({
  ...
  const showLegendHandler =
    (type: 'finish' | 'init' | 'resolve'): React.MouseEventHandler<HTMLDivElement> =>
    (event) => {
      ...
      <div className={styles.controls}>
        {
          <div className={cn(styles.legend, legend ? styles.show : null)}>
            ...
            <Button
              ...
              color="black"
              borderless
              value={t(`players.timeoutButtons.${legend}`)!}
        ...
        >
          ...
          <span className={styles.hint} onClick={showLegendHandler('init')}>
            ?
          </span>
        </div>
        <div
        ...
        >
          ...
          <span className={styles.hint} onClick={showLegendHandler('resolve')}>
            ?
          </span>
        </div>
        <div
        ...
        >
          ...
          <span className={styles.hint} onClick={showLegendHandler('finish')}>
            ?
          </span>
        </div>
