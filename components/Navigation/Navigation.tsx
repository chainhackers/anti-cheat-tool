        ...
        <div className={styles.navigation__menu}>
          ...
          <ul className={styles.navigation__list_sm}>
            <li className={styles.navigation__list_item}>
              {/* <Link className={styles.navigation__link}> */}
              <a href="/games" className={styles.navigation__link}>
        ...
        <ul className={styles.navigation__list}>
          <li className={styles.navigation__list_item}>
            <Link href="/games" className={styles.navigation__link}>
              <a className={styles.navigation__link}>{t('navigation.gameDemo')}</a>
            </Link>
          </li>
          <li className={styles.navigation__list_item}>
            <Link
              ...
              className={styles.navigation__link}
            >
              <a className={styles.navigation__link}>{t('navigation.documents')}</a>
            </Link>
          </li>
          <li className={styles.navigation__list_item}>
            <Link href="/team" className={styles.navigation__link}>
              <a className={styles.navigation__link}>{t('navigation.team')}</a>
            </Link>
          </li>
          <li className={styles.navigation__list_item}>
            <Link
